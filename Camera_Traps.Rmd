...
camtrap_metadata <- read.csv("docs/data/camtrap_metadata.csv",header = T, sep = ",")
library(DT)
...
```{r echo=FALSE}
xfun::embed_file('docs/data/camera data first 53/sequences.csv')
```
...
```{r echo=FALSE}
xfun::embed_file('docs/data/camera data first 53/projects.csv')
xfun::embed_file('docs/data/camera data first 53/images_2007494.csv')
xfun::embed_file('docs/data/camera data first 53/deployments.csv')
xfun::embed_file('docs/data/camera data first 53/cameras.csv')
```  
...
cam.data <- read.csv('docs/data/camera data first 53/sequences.csv')
