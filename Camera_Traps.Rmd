...
camtrap_metadata <- read.csv("media/data/camtrap_metadata.csv",header = T, sep = ",")
library(DT)
...
#```{r echo=FALSE}
xfun::embed_file('docs/data/Ponterra camera traps PON001-100/sequences.csv')
```
...
#```{r echo=FALSE}
xfun::embed_file('docs/data/Ponterra camera traps PON001-100/projects.csv')
xfun::embed_file('docs/data/Ponterra camera traps PON001-100/images_2007494.csv')
xfun::embed_file('docs/data/Ponterra camera traps PON001-100/deployments.csv')
xfun::embed_file('docs/data/Ponterra camera traps PON001-100/cameras.csv')
```  
...
cam.data <- read.csv('docs/data/Ponterra camera traps PON001-100/sequences.csv')
cam.metadata <- read.csv('docs/data/camtrap_metadata.csv')
