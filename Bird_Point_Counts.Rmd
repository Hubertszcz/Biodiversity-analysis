...
Each sampling point had two



There are two csv files for this analysis, one with sampling point metadata and one with bird point count data: 
```{r echo=FALSE}
#xfun::embed_file('docs/data/Ponterra deployments PON001-150.csv')
```  

```{r echo=FALSE}
#xfun::embed_file('docs/data/Ponterra point counts PON001-100.csv')
```  
...
# Load the datasets
metadata <- read.csv('docs/data/Ponterra deployments PON001-150.csv')
data <- read.csv('docs/data/Ponterra point counts PON001-100.csv')
